...
public class Countdown5 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (seconds == 0)
        {
            ...
            SceneManager.LoadScene("Scenes/Final scene");
        }
    ...
    void escojerRecetas()
    {
        ...
        if (n >= 1 && n <= 1)
        {
            recetas.Add(7);
            if (numero_recetas < 5)
                objetos_recetas.Add((GameObject)Instantiate(Receta_6, new Vector3(-5.5f + 2.75f * (numero_recetas - 1), 14, -10.75f), Receta_6.transform.rotation));
        ...
        else if (n >= 4 && n <= 6)
        {
            recetas.Add(7);
            if (numero_recetas < 5)
                objetos_recetas.Add((GameObject)Instantiate(Receta_7, new Vector3(-5.5f + 2.75f * (numero_recetas - 1), 14, -10.75f), Receta_7.transform.rotation));
        }
        else
        {
            recetas.Add(8);
